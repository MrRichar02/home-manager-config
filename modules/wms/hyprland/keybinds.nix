{
  ...
  '';
	...
	'';
in {
  options.myModules.hyprland1.keybinds.enable = lib.mkEnableOption "enables keybinds for hyprland config 1";

  config = lib.mkIf config.myModules.hyprland1.keybinds.enable {
    home.packages = [
