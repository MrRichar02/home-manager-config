    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        exec-once = [
          ...
          "${pkgs.clipse}/bin/clipse -listen" # run listener on startup
        ];
        ...
        bind =
          [
            ...
            "SUPER, C, exec, ${pkgs.kitty}/bin/kitty --class clipse -e '${pkgs.clipse}/bin/clipse'"
        ...
        windowrulev2 = [
          ...
          "size 1700 1000,class:(clipse)" # set the size of the window as necessary

          "float,class:(wiremix) "
          "size 1700 1000,class:(wiremix)"
        ];
      };
    };
  };
